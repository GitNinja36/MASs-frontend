  ...
  return (
    <section className="flex flex-col overflow-hidden w-full h-screen relative items-center justify-center">
      ...
      <div className="relative z-20 text-center max-w-5xl px-6">
        ...
        {/* Description */}
        <p className="md:text-xl leading-relaxed text-lg font-light max-w-2xl mx-auto mb-10 text-gray-400">
          AI twins built from 16+ platforms deliver instant, authentic survey responses. 
          No recruitment. No bias. Just data.
        </p>
