        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 relative">
          ...
          <div className="order-1 lg:order-2 py-20 pb-0">
            ...
            <p className="text-lg mb-8 leading-relaxed text-gray-400">
              Ask one sharp question Market Survey Agent sends it to the right AI personas and returns decision ready insight in seconds.
            </p>

            {/* Step 1 */}
            <div className="step-item mb-48 pt-10 opacity-30 transition-opacity duration-500">
              <h3 className="text-4xl font-display font-bold mb-4 text-white">01. Ask the Question</h3>
              <p className="text-xl leading-relaxed font-light text-white/80">
                Turn your hunch into a sharp prompt capture the exact outcome, feature, or bet you want tested in one focused survey question.
              </p>
            </div>

            {/* Step 2 */}
            <div className="step-item mb-48 opacity-30 transition-opacity duration-500">
              <h3 className="text-4xl font-display font-bold mb-4 text-white">02. Shape the Choices</h3>
              <p className="text-xl leading-relaxed font-light text-white/80">
                Add the options you want to test. Multi Survey Agent turns them into clean A/B/C comparisons for every AI persona.
              </p>
            </div>

            {/* Step 3 */}
            <div className="step-item opacity-30 transition-opacity duration-500">
              <h3 className="text-4xl font-display font-bold mb-4 text-white">03. Target the Cohort</h3>
              <p className="text-xl leading-relaxed font-light text-white/80">
                Drop in a cohort query like "Gamers in Mumbai" or "US founders 25-35" and instantly route the question to the right agents.
              </p>
            </div>
