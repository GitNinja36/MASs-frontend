      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-lg mb-8 leading-relaxed text-gray-400">
            Stop guessing with blunt averages Multi Survey Agent Modes let you pick how many AI twins to sample per question, balancing speed with depth in a click.
          </p>
