...
interface SurveyContextType {
  ...
  updateQuestion: (index: number, field: 'question' | 'options' | 'agentMode' | 'cohortQuery', value: string | string[] | AgentMode) => void
...
export function SurveyProvider({ children }: { children: ReactNode }) {
  ...
  function updateQuestion(
    index: number, 
    field: 'question' | 'options' | 'agentMode' | 'cohortQuery', 
    value: string | string[] | AgentMode
  ) {
